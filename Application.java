...
public class Application implements Serializable {
	...
	private static final String secret_phrase = "vikasismyfavoritestudent";
	...
	public static void login() {
		...
		while (true) {
			System.out.println("\nWelcome to the Course Management System (CMS). Please login.\nType vikasismyfavoritestudent to exit.\n");
			System.out.print("Username: "); String username_input = input.next();

			if (username_input.equals(secret_phrase)) {
				break;
			}

			System.out.print("Password: "); String password_input = input.next();

			if (password_input.equals(secret_phrase)) {
				break;
			}

			if (username_input.equals(admin.get_username()) && password_input.equals(admin.get_password())) {
				approved = true;
				admin_menu();
			}
				...
				for (int i = 0; i < student_list.get_student_list().size(); i++) {
					if (username_input.equals(student_list.get_student_list().get(i).get_username()) && password_input.equals(student_list.get_student_list().get(i).get_password())) {
						approved = true;
	...
	public static void admin_menu() {
		...
		while (selection != 3) {
			...
			System.out.print("Enter: "); selection = Integer.parseInt(input.next()); input.nextLine();

			while (selection != 1 && selection != 2 && selection != 3) {
				System.out.print("Invalid. Enter: "); selection = Integer.parseInt(input.next()); input.nextLine();
			}
			...
			if (selection == 1) {
				while (selection != 6) {
					...
					if (selection == 2) {
						System.out.print("\nEnter the ID of the course to remove: "); int course_id_search = Integer.parseInt(input.next()); input.nextLine();
						System.out.print("Enter the section # of the course: "); int course_section_search = Integer.parseInt(input.next()); input.nextLine();

						course_list.delete(course_id_search, course_section_search);
					}

					if (selection == 3) {
						System.out.print("\nEnter the ID of the course to edit: "); int course_id_search = Integer.parseInt(input.next()); input.nextLine();
						System.out.print("Enter the section # of the course: "); int course_section_search = Integer.parseInt(input.next()); input.nextLine();
					...
					if (selection == 4) {
						System.out.print("\nEnter the ID of the course to view: "); int course_id_search = Integer.parseInt(input.next()); input.nextLine();
						System.out.print("Enter the section # of the course: "); int course_section_search = Integer.parseInt(input.next()); input.nextLine();
			...
			if (selection == 2) {
				while (selection != 6) {
					...
					if (selection == 3) {
						System.out.print("\nEnter the ID of the course to view registry: "); int course_id_search = Integer.parseInt(input.next()); input.nextLine();
						System.out.print("Enter the section # of the course: "); int course_section_search = Integer.parseInt(input.next()); input.nextLine();
					...
					if (selection == 4) {
						System.out.print("\nEnter the ID of the student to view their registration: "); int student_id_search = Integer.parseInt(input.next()); input.nextLine();
	...
	public static void student_menu(Student student) {
		...
		while (selection != 6) {
			...
			if (selection == 3) {
				System.out.print("\nEnter the ID of the course to which you would like to register: "); int course_id_search = Integer.parseInt(input.next()); input.nextLine();
				System.out.print("Enter the section # of the course: "); int course_section_search = Integer.parseInt(input.next()); input.nextLine();
			...
			if (selection == 4) {
				System.out.print("\nEnter the ID of the course to which you would like to withdraw: "); int course_id_search = Integer.parseInt(input.next()); input.nextLine();
				System.out.print("Enter the section # of the course: "); int course_section_search = Integer.parseInt(input.next()); input.nextLine();
	...
	public static void serialize() {
		try {
			...
			FileOutputStream student_list_fos = new FileOutputStream("StudentList.ser");
			
			// object writer

			ObjectOutputStream course_list_oos = new ObjectOutputStream(course_list_fos);
			ObjectOutputStream student_list_oos = new ObjectOutputStream(student_list_fos);
	...
	public static void deserialize() {
		if (new File("CourseList.ser").exists() && new File("StudentList.ser").exists()) {
			try {
				
				// file reader

				FileInputStream course_list_fis = new FileInputStream("CourseList.ser");
				FileInputStream student_list_fis = new FileInputStream("StudentList.ser");

				// object reader

				ObjectInputStream course_list_ois = new ObjectInputStream(course_list_fis);
				ObjectInputStream student_list_ois = new ObjectInputStream(student_list_fis);
		...
		// populate if no .ser files

		else {
			course_list.populate();
		}
	}
}